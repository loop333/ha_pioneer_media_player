...
from homeassistant.components.media_player import (
    MediaPlayerDevice, PLATFORM_SCHEMA, SUPPORT_PAUSE, SUPPORT_SELECT_SOURCE, SUPPORT_SELECT_SOUND_MODE,
...
if __name__ == '__main__':
    pioneer = PioneerDevice('pioneer_xsmc55s', '192.168.1.7', '8102', 1)
